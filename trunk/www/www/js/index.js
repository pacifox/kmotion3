...
KM.conf_config_track_send = function(coded_str) {  
...
KM.conf_config_track = function() {
	...
	sync: function() {
	    ...
	    //}
	    alert('aa')
	    KM.add_timeout_id(KM.CONFIG_SEND, setTimeout(function () {xxx(coded_str); }, 1)); //////////////////////////////////
	    ///KM.add_timeout_id(KM.CONFIG_SEND, setTimeout(function () {KM.conf_config_track_send(coded_str); }, 1));
